...
\newcommand{\titlename}{Equations and Graphs}           % change title of document
\newcommand{\authorname}{Alex Buedding}                 % and name of author here
...
\sisetup{locale=DE,per-mode=symbol}                     % german punctuation for numbers and inline units
...
\usepackage[siunitx,
            ...
            EFvoltages,
            europeanresistors,
            americaninductors]{circuitikz}              % usage of simplified commands for drawing electrical circuits
